...
def mildew_detector_body():
    st.info(
        f"* The client is interested in telling whether a given leaf has powdery mildew "
        f"or not."
        )

    st.write(
        f"* You can download a set of healthy and infected leaves for live prediction. "
